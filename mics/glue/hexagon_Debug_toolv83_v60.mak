...
tree: MAKE_D_3_LIBDIR MAKE_D_EXT_4_DIR MAKE_D_3_LIBDIR MAKE_D_2_LIBDIR MAKE_D_1_LIBDIR MAKE_D_5_INCDIR MAKE_D_1_LIBDIR MAKE_D_2_LIBDIR MAKE_D_5_INCDIR
	$(call job,,$(MAKE) V=hexagon_Debug_toolv83_v60,making .)
...
tree_clean: MAKE_D_3_LIBDIR_clean MAKE_D_EXT_4_DIR_clean MAKE_D_3_LIBDIR_clean MAKE_D_2_LIBDIR_clean MAKE_D_1_LIBDIR_clean MAKE_D_5_INCDIR_clean MAKE_D_1_LIBDIR_clean MAKE_D_2_LIBDIR_clean MAKE_D_5_INCDIR_clean
	$(call job,,$(MAKE) V=hexagon_Debug_toolv83_v60 clean,cleaning .)

MAKE_D_5_INCDIR: 
	$(call job,$(HEXAGON_SDK_ROOT)/test/common/test_main,$(MAKE) V=hexagon_Debug_toolv83_v60,making $(HEXAGON_SDK_ROOT)/test/common/test_main)

MAKE_D_5_INCDIR_clean: 
	$(call job,$(HEXAGON_SDK_ROOT)/test/common/test_main,$(MAKE) V=hexagon_Debug_toolv83_v60 clean,cleaning $(HEXAGON_SDK_ROOT)/test/common/test_main)

MAKE_D_3_LIBDIR: MAKE_D_EXT_4_DIR MAKE_D_1_LIBDIR MAKE_D_2_LIBDIR
	$(call job,$(HEXAGON_SDK_ROOT)/libs/common/rpcmem,$(MAKE) V=hexagon_Debug_toolv83_v60,making $(HEXAGON_SDK_ROOT)/libs/common/rpcmem)

MAKE_D_3_LIBDIR_clean: MAKE_D_EXT_4_DIR_clean MAKE_D_1_LIBDIR_clean MAKE_D_2_LIBDIR_clean
	$(call job,$(HEXAGON_SDK_ROOT)/libs/common/rpcmem,$(MAKE) V=hexagon_Debug_toolv83_v60 clean,cleaning $(HEXAGON_SDK_ROOT)/libs/common/rpcmem)

MAKE_D_2_LIBDIR: 
	$(call job,$(HEXAGON_SDK_ROOT)/libs/common/atomic,$(MAKE) V=hexagon_Debug_toolv83_v60,making $(HEXAGON_SDK_ROOT)/libs/common/atomic)

MAKE_D_2_LIBDIR_clean: 
	$(call job,$(HEXAGON_SDK_ROOT)/libs/common/atomic,$(MAKE) V=hexagon_Debug_toolv83_v60 clean,cleaning $(HEXAGON_SDK_ROOT)/libs/common/atomic)

MAKE_D_1_LIBDIR: 
	$(call job,$(HEXAGON_SDK_ROOT)/test/common/test_util,$(MAKE) V=hexagon_Debug_toolv83_v60,making $(HEXAGON_SDK_ROOT)/test/common/test_util)

MAKE_D_1_LIBDIR_clean: 
	$(call job,$(HEXAGON_SDK_ROOT)/test/common/test_util,$(MAKE) V=hexagon_Debug_toolv83_v60 clean,cleaning $(HEXAGON_SDK_ROOT)/test/common/test_util)
