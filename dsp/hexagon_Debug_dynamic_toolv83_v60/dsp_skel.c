...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(dsp_skel_invoke)(uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      case 0:
      return _skel_method((void*)__QAIC_IMPL(dsp_fft), _sc, _pra);
   }
