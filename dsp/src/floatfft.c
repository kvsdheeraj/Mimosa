...
/*****************************************************************/
void sfpFFT(cfloat *input, int N, cfloat *w, cfloat *output)
{
  int i, j, k1, k2, n, m;
  cfloat Wa,Wb,Wc;
  cfloat A[4];
  ...
  /*************************************/
     for(i=0, m=0; i<N; i+=4)
     {
       A[0]= input[ fbitrev(i  , LOG2N) ];
       A[1]= input[ fbitrev(i+1, LOG2N) ];
       A[2]= input[ fbitrev(i+2, LOG2N) ];
       A[3]= input[ fbitrev(i+3, LOG2N) ];
